...
public class Stream_baisc {
    ...
    public static void main(String[] args) {
        ...
        // - collect() com.lucas.stream 데이터를 변형, 처리 하여 원하는 자료형으로 변환.
        // ->> List, set 자료형으로 변환, joining, Sorting,
        List<Integer> result = list.stream().sorted().collect(Collectors.toList());
//        List<Integer> result = list.com.lucas.stream().sorted(Comparator.reverseOrder()).collect(Collectors.toList()); // desc
